                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('register.perform')); ?>">
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="text" name="username" class="form-control" placeholder="Username" aria-label="Name" value="<?php echo e(old('username')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="email" name="email" class="form-control" placeholder="Email" aria-label="Email" value="<?php echo e(old('email')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <p class="text-sm mt-3 mb-0">Already have an account? <a href="<?php echo e(route('login')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SunFlowers\resources\views/auth/register.blade.php ENDPATH**/ ?>