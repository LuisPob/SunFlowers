    ...
    <div class="card shadow-lg">
        <div class="card-header pb-0 pt-3 ">
            <div class="float-start">
                <h5 class="mt-3 mb-0">Configuración de panel</h5>
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            ...
            <div class="d-flex">
                <button class="btn bg-gradient-primary text-dark w-100 px-3 mb-2 active me-2" data-class="bg-white"
                    onclick="sidebarType(this) ">Blanco</button>
                <button class="btn bg-gradient-primary text-dark w-100 px-3 mb-2" data-class="bg-default"
