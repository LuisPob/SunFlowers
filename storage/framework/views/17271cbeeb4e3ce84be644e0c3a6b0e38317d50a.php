    ...
    <div class="card-body p-3">
        <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
                <div class="h-100">
                    <h5 class="mb-1">
                        <?php echo e(auth()->user()->firstname ?? 'Firstname'); ?> <?php echo e(auth()->user()->lastname ?? 'Lastname'); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="address" value="<?php echo e(old('address', auth()->user()->address)); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="about" value="<?php echo e(old('about', auth()->user()->about)); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Esta a punto de realizar una acción irreversible. ¿Estas seguro de que deseas eliminar tu cuenta?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <form action="<?php echo e(route('account.delete')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', ['class' => 'g-sidenav-show bg-gray-100'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SunFlowers\resources\views/pages/user-profile.blade.php ENDPATH**/ ?>